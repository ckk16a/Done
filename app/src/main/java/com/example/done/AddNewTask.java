...
public class AddNewTask extends BottomSheetDialogFragment {
    ...
    public static AddNewTask newInstance(String theEvent){
        event = theEvent;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newDescriptionText = getView().findViewById(R.id.newDescriptionText);
        ...
        if(bundle != null){
            ...
            newTaskText.setText(description);
            assert task != null;
            if(task.length()>0)
        ...
        newDescriptionText.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            }
